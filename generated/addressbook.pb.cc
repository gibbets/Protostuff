...
extern PROTOBUF_INTERNAL_EXPORT_addressbook_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Sperrgut_addressbook_2eproto;
namespace tutorial {
...
class SperrgutDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<Sperrgut> _instance;
} _Sperrgut_default_instance_;
class muellDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<muell> _instance;
} _muell_default_instance_;
}  // namespace tutorial
...
static void InitDefaultsscc_info_Sperrgut_addressbook_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::tutorial::_Sperrgut_default_instance_;
    new (ptr) ::tutorial::Sperrgut();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::tutorial::Sperrgut::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Sperrgut_addressbook_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Sperrgut_addressbook_2eproto}, {}};

static void InitDefaultsscc_info_muell_addressbook_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::tutorial::_muell_default_instance_;
    new (ptr) ::tutorial::muell();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::tutorial::muell::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_muell_addressbook_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_muell_addressbook_2eproto}, {
      &scc_info_Sperrgut_addressbook_2eproto.base,}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_addressbook_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,
  PROTOBUF_FIELD_OFFSET(::tutorial::Sperrgut, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::tutorial::Sperrgut, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::tutorial::Sperrgut, name_),
  PROTOBUF_FIELD_OFFSET(::tutorial::Sperrgut, weight_),
  0,
  1,
  PROTOBUF_FIELD_OFFSET(::tutorial::muell, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::tutorial::muell, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::tutorial::muell, sperrgut_),
  ~0u,
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 29, 36, sizeof(::tutorial::Sperrgut)},
  { 38, 44, sizeof(::tutorial::muell)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::tutorial::_Sperrgut_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::tutorial::_muell_default_instance_),
};
...
const char descriptor_table_protodef_addressbook_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\030\001 \002(\t\022\016\n\006weight\030\002 \002(\005\"-\n\005muell\022$\n\010sperr"
  "gut\030\001 \003(\0132\022.tutorial.Sperrgut"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_addressbook_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_addressbook_2eproto_sccs[5] = {
  &scc_info_AddressBook_addressbook_2eproto.base,
  &scc_info_Person_addressbook_2eproto.base,
  &scc_info_Person_PhoneNumber_addressbook_2eproto.base,
  &scc_info_Sperrgut_addressbook_2eproto.base,
  &scc_info_muell_addressbook_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_addressbook_2eproto = {
  &descriptor_table_addressbook_2eproto_initialized, descriptor_table_protodef_addressbook_2eproto, "addressbook.proto", 389,
  &descriptor_table_addressbook_2eproto_once, descriptor_table_addressbook_2eproto_sccs, descriptor_table_addressbook_2eproto_deps, 5, 0,
  schemas, file_default_instances, TableStruct_addressbook_2eproto::offsets,
  file_level_metadata_addressbook_2eproto, 5, file_level_enum_descriptors_addressbook_2eproto, file_level_service_descriptors_addressbook_2eproto,
};
...
void Sperrgut::InitAsDefaultInstance() {
}
class Sperrgut::_Internal {
 public:
  using HasBits = decltype(std::declval<Sperrgut>()._has_bits_);
  static void set_has_name(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
...
Sperrgut::Sperrgut()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:tutorial.Sperrgut)
}
Sperrgut::Sperrgut(const Sperrgut& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      _internal_metadata_(nullptr),
      _has_bits_(from._has_bits_) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ...
  // @@protoc_insertion_point(copy_constructor:tutorial.Sperrgut)
}

void Sperrgut::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Sperrgut_addressbook_2eproto.base);
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  weight_ = 0;
}

Sperrgut::~Sperrgut() {
  // @@protoc_insertion_point(destructor:tutorial.Sperrgut)
  SharedDtor();
}

void Sperrgut::SharedDtor() {
  name_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

void Sperrgut::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const Sperrgut& Sperrgut::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_Sperrgut_addressbook_2eproto.base);
  return *internal_default_instance();
}
...
void Sperrgut::Clear() {
// @@protoc_insertion_point(message_clear_start:tutorial.Sperrgut)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* Sperrgut::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  _Internal::HasBits has_bits{};
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "tutorial.Sperrgut.name");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* Sperrgut::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:tutorial.Sperrgut)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:tutorial.Sperrgut)
  return target;
}

size_t Sperrgut::RequiredFieldsByteSizeFallback() const {
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:tutorial.Sperrgut)
  size_t total_size = 0;
...
size_t Sperrgut::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:tutorial.Sperrgut)
  size_t total_size = 0;
...
void Sperrgut::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:tutorial.Sperrgut)
  GOOGLE_DCHECK_NE(&from, this);
  const Sperrgut* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Sperrgut>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:tutorial.Sperrgut)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:tutorial.Sperrgut)
    MergeFrom(*source);
  }
}

void Sperrgut::MergeFrom(const Sperrgut& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:tutorial.Sperrgut)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void Sperrgut::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:tutorial.Sperrgut)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void Sperrgut::CopyFrom(const Sperrgut& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:tutorial.Sperrgut)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool Sperrgut::IsInitialized() const {
  if ((_has_bits_[0] & 0x00000003) != 0x00000003) return false;
  return true;
}

void Sperrgut::InternalSwap(Sperrgut* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
  swap(_has_bits_[0], other->_has_bits_[0]);
  name_.Swap(&other->name_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
::PROTOBUF_NAMESPACE_ID::Metadata Sperrgut::GetMetadata() const {
  return GetMetadataStatic();
}
...
void muell::InitAsDefaultInstance() {
}
class muell::_Internal {
 public:
  using HasBits = decltype(std::declval<muell>()._has_bits_);
};

muell::muell()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:tutorial.muell)
}
muell::muell(const muell& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      _internal_metadata_(nullptr),
      _has_bits_(from._has_bits_),
      sperrgut_(from.sperrgut_) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  // @@protoc_insertion_point(copy_constructor:tutorial.muell)
}

void muell::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_muell_addressbook_2eproto.base);
}

muell::~muell() {
  // @@protoc_insertion_point(destructor:tutorial.muell)
  SharedDtor();
}

void muell::SharedDtor() {
}

void muell::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const muell& muell::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_muell_addressbook_2eproto.base);
  return *internal_default_instance();
}
...
void muell::Clear() {
// @@protoc_insertion_point(message_clear_start:tutorial.muell)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* muell::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
    CHK_(ptr);
    switch (tag >> 3) {
      // repeated .tutorial.Sperrgut sperrgut = 1;
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr -= 1;
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_sperrgut(), ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
          } while (::PROTOBUF_NAMESPACE_ID::internal::ExpectTag<10>(ptr));
        } else goto handle_unusual;
...
::PROTOBUF_NAMESPACE_ID::uint8* muell::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:tutorial.muell)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;

  // repeated .tutorial.Sperrgut sperrgut = 1;
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->_internal_sperrgut_size()); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(1, this->_internal_sperrgut(i), target, stream);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:tutorial.muell)
  return target;
}

size_t muell::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:tutorial.muell)
  size_t total_size = 0;
  ...
  // repeated .tutorial.Sperrgut sperrgut = 1;
  total_size += 1UL * this->_internal_sperrgut_size();
  for (const auto& msg : this->sperrgut_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
...
void muell::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:tutorial.muell)
  GOOGLE_DCHECK_NE(&from, this);
  const muell* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<muell>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:tutorial.muell)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:tutorial.muell)
    MergeFrom(*source);
  }
}

void muell::MergeFrom(const muell& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:tutorial.muell)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;

  sperrgut_.MergeFrom(from.sperrgut_);
}

void muell::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:tutorial.muell)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void muell::CopyFrom(const muell& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:tutorial.muell)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool muell::IsInitialized() const {
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(sperrgut_)) return false;
  return true;
}

void muell::InternalSwap(muell* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
  swap(_has_bits_[0], other->_has_bits_[0]);
  sperrgut_.InternalSwap(&other->sperrgut_);
}

::PROTOBUF_NAMESPACE_ID::Metadata muell::GetMetadata() const {
  return GetMetadataStatic();
}
...
template<> PROTOBUF_NOINLINE ::tutorial::Sperrgut* Arena::CreateMaybeMessage< ::tutorial::Sperrgut >(Arena* arena) {
  return Arena::CreateInternal< ::tutorial::Sperrgut >(arena);
}
template<> PROTOBUF_NOINLINE ::tutorial::muell* Arena::CreateMaybeMessage< ::tutorial::muell >(Arena* arena) {
  return Arena::CreateInternal< ::tutorial::muell >(arena);
}
