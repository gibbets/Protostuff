...
extern SperrgutDefaultTypeInternal _Sperrgut_default_instance_;
class muell;
class muellDefaultTypeInternal;
extern muellDefaultTypeInternal _muell_default_instance_;
}  // namespace tutorial
PROTOBUF_NAMESPACE_OPEN
...
template<> ::tutorial::Sperrgut* Arena::CreateMaybeMessage<::tutorial::Sperrgut>(Arena*);
template<> ::tutorial::muell* Arena::CreateMaybeMessage<::tutorial::muell>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tutorial {
...
class Sperrgut :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tutorial.Sperrgut) */ {
 public:
  Sperrgut();
  virtual ~Sperrgut();

  Sperrgut(const Sperrgut& from);
  Sperrgut(Sperrgut&& from) noexcept
    : Sperrgut() {
    *this = ::std::move(from);
  }

  inline Sperrgut& operator=(const Sperrgut& from) {
    CopyFrom(from);
    return *this;
  }
  inline Sperrgut& operator=(Sperrgut&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const Sperrgut& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const Sperrgut* internal_default_instance() {
    return reinterpret_cast<const Sperrgut*>(
               &_Sperrgut_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  friend void swap(Sperrgut& a, Sperrgut& b) {
    a.Swap(&b);
  }
  inline void Swap(Sperrgut* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline Sperrgut* New() const final {
    return CreateMaybeMessage<Sperrgut>(nullptr);
  }

  Sperrgut* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<Sperrgut>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const Sperrgut& from);
  void MergeFrom(const Sperrgut& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(Sperrgut* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tutorial.Sperrgut";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:tutorial.Sperrgut)
 private:
  class _Internal;
...
class muell :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tutorial.muell) */ {
 public:
  muell();
  virtual ~muell();

  muell(const muell& from);
  muell(muell&& from) noexcept
    : muell() {
    *this = ::std::move(from);
  }

  inline muell& operator=(const muell& from) {
    CopyFrom(from);
    return *this;
  }
  inline muell& operator=(muell&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const muell& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const muell* internal_default_instance() {
    return reinterpret_cast<const muell*>(
               &_muell_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    4;

  friend void swap(muell& a, muell& b) {
    a.Swap(&b);
  }
  inline void Swap(muell* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline muell* New() const final {
    return CreateMaybeMessage<muell>(nullptr);
  }

  muell* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<muell>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const muell& from);
  void MergeFrom(const muell& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(muell* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tutorial.muell";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  enum : int {
    kSperrgutFieldNumber = 1,
  };
  // repeated .tutorial.Sperrgut sperrgut = 1;
  int sperrgut_size() const;
  private:
  int _internal_sperrgut_size() const;
  public:
  void clear_sperrgut();
  ::tutorial::Sperrgut* mutable_sperrgut(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tutorial::Sperrgut >*
      mutable_sperrgut();
  private:
  const ::tutorial::Sperrgut& _internal_sperrgut(int index) const;
  ::tutorial::Sperrgut* _internal_add_sperrgut();
  public:
  const ::tutorial::Sperrgut& sperrgut(int index) const;
  ::tutorial::Sperrgut* add_sperrgut();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tutorial::Sperrgut >&
      sperrgut() const;

  // @@protoc_insertion_point(class_scope:tutorial.muell)
 private:
  class _Internal;
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tutorial::Sperrgut > sperrgut_;
  friend struct ::TableStruct_addressbook_2eproto;
};
// ===================================================================
...
// required string name = 1;
inline bool Sperrgut::_internal_has_name() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool Sperrgut::has_name() const {
  return _internal_has_name();
}
inline void Sperrgut::clear_name() {
  name_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  _has_bits_[0] &= ~0x00000001u;
}
inline const std::string& Sperrgut::name() const {
  // @@protoc_insertion_point(field_get:tutorial.Sperrgut.name)
  return _internal_name();
}
inline void Sperrgut::set_name(const std::string& value) {
  _internal_set_name(value);
  // @@protoc_insertion_point(field_set:tutorial.Sperrgut.name)
}
inline std::string* Sperrgut::mutable_name() {
  // @@protoc_insertion_point(field_mutable:tutorial.Sperrgut.name)
  return _internal_mutable_name();
}
inline const std::string& Sperrgut::_internal_name() const {
  return name_.GetNoArena();
}
inline void Sperrgut::_internal_set_name(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void Sperrgut::set_name(std::string&& value) {
  _has_bits_[0] |= 0x00000001u;
  name_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:tutorial.Sperrgut.name)
}
inline void Sperrgut::set_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000001u;
  name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:tutorial.Sperrgut.name)
}
inline void Sperrgut::set_name(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000001u;
  name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:tutorial.Sperrgut.name)
}
inline std::string* Sperrgut::_internal_mutable_name() {
  _has_bits_[0] |= 0x00000001u;
  return name_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* Sperrgut::release_name() {
  // @@protoc_insertion_point(field_release:tutorial.Sperrgut.name)
  if (!_internal_has_name()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000001u;
...
inline void Sperrgut::set_allocated_name(std::string* name) {
  if (name != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  } else {
    _has_bits_[0] &= ~0x00000001u;
  ...
  name_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), name);
  // @@protoc_insertion_point(field_set_allocated:tutorial.Sperrgut.name)
}

// required int32 weight = 2;
inline bool Sperrgut::_internal_has_weight() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool Sperrgut::has_weight() const {
  return _internal_has_weight();
}
inline void Sperrgut::clear_weight() {
  weight_ = 0;
  _has_bits_[0] &= ~0x00000002u;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Sperrgut::_internal_weight() const {
  return weight_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Sperrgut::weight() const {
  // @@protoc_insertion_point(field_get:tutorial.Sperrgut.weight)
  return _internal_weight();
}
inline void Sperrgut::_internal_set_weight(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000002u;
  weight_ = value;
}
inline void Sperrgut::set_weight(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_weight(value);
  // @@protoc_insertion_point(field_set:tutorial.Sperrgut.weight)
}
...
// repeated .tutorial.Sperrgut sperrgut = 1;
inline int muell::_internal_sperrgut_size() const {
  return sperrgut_.size();
}
inline int muell::sperrgut_size() const {
  return _internal_sperrgut_size();
}
inline void muell::clear_sperrgut() {
  sperrgut_.Clear();
}
inline ::tutorial::Sperrgut* muell::mutable_sperrgut(int index) {
  // @@protoc_insertion_point(field_mutable:tutorial.muell.sperrgut)
  return sperrgut_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tutorial::Sperrgut >*
muell::mutable_sperrgut() {
  // @@protoc_insertion_point(field_mutable_list:tutorial.muell.sperrgut)
  return &sperrgut_;
}
inline const ::tutorial::Sperrgut& muell::_internal_sperrgut(int index) const {
  return sperrgut_.Get(index);
}
inline const ::tutorial::Sperrgut& muell::sperrgut(int index) const {
  // @@protoc_insertion_point(field_get:tutorial.muell.sperrgut)
  return _internal_sperrgut(index);
}
inline ::tutorial::Sperrgut* muell::_internal_add_sperrgut() {
  return sperrgut_.Add();
}
inline ::tutorial::Sperrgut* muell::add_sperrgut() {
  // @@protoc_insertion_point(field_add:tutorial.muell.sperrgut)
  return _internal_add_sperrgut();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tutorial::Sperrgut >&
muell::sperrgut() const {
  // @@protoc_insertion_point(field_list:tutorial.muell.sperrgut)
  return sperrgut_;
}
